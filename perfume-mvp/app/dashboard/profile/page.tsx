...
export default function ProfilePage() {
  ...
  async function onDeleteAccount() {
    if (!confirm("This will permanently delete your account and all associated data. This action cannot be undone. Are you sure you want to continue?")) return;
    ...
    <div className="max-w-4xl mx-auto space-y-8 pb-16">
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-gray-100/30">
          ...
          <p className="text-sm text-gray-600 mt-1">Update your personal details and how others see you</p>
        </div>
        ...
        <form onSubmit={onSave} className="p-6 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              <label className="block text-sm font-medium text-gray-700">Messenger Link</label>
              <input
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all"
            ...
            <div className="md:col-span-2 space-y-2">
              <label className="block text-sm font-medium text-gray-700">Contact Link</label>
              <input
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all"
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div className="space-y-1">
              ...
              <p className="text-sm text-red-700 max-w-2xl">
                Permanently delete your account, profile, listings, favorites, and all personal data. 
                This action cannot be undone and you will lose access to all your information.
              </p>
            </div>
